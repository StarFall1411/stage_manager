...
const TagSchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'inventoryItems': LinkSchema(
      id: 4576878126565073148,
...
List<IsarLinkBase<dynamic>> _tagGetLinks(Tag object) {
  return [object.inventoryItems];
}

void _tagAttach(IsarCollection<dynamic> col, Id id, Tag object) {
  object.id = id;
  object.inventoryItems
      .attach(col, col.isar.collection<InventoryItem>(), r'inventoryItems', id);
}
...
extension TagQueryLinks on QueryBuilder<Tag, Tag, QFilterCondition> {
  QueryBuilder<Tag, Tag, QAfterFilterCondition> inventoryItems(
      FilterQuery<InventoryItem> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'inventoryItems');
    });
  }

  QueryBuilder<Tag, Tag, QAfterFilterCondition> inventoryItemsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'inventoryItems', length, true, length, true);
    });
  }

  QueryBuilder<Tag, Tag, QAfterFilterCondition> inventoryItemsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'inventoryItems', 0, true, 0, true);
    });
  }

  QueryBuilder<Tag, Tag, QAfterFilterCondition> inventoryItemsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'inventoryItems', 0, false, 999999, true);
    });
  }

  QueryBuilder<Tag, Tag, QAfterFilterCondition> inventoryItemsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'inventoryItems', 0, true, length, include);
    });
  }

  QueryBuilder<Tag, Tag, QAfterFilterCondition> inventoryItemsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'inventoryItems', length, include, 999999, true);
    });
  }

  QueryBuilder<Tag, Tag, QAfterFilterCondition> inventoryItemsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'inventoryItems', lower, includeLower, upper, includeUpper);
    });
  }
}
